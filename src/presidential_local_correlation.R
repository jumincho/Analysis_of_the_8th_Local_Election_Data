...
vote_7=read.csv("data/07_local_vote_share.csv",header=T)
vote_8=read.csv("data/08_local_vote_share.csv",header=T)
vote_20=read.csv("data/20th_presidential_vote_share.csv",header=T)
